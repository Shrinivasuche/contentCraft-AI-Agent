...
Built for the Rooman AI Agent Development Challenge.
...
Tone of voice (Casual, Bold, Professional, etc.)

Language (English, Hindi, Kannada, Tamil, Telugu)

Number of posts (1–10)

Brand description, niche, and campaign goal
...
🏗 Architecture:
             ...
             └──────────────────────────┘
                          ...
                          ▼
        ┌────────────────────────────────────┐
        │  Google Gemini API (flash-latest)  │
        └────────────────────────────────────┘
                          │
                          ▼
                ┌────────────────────┐
